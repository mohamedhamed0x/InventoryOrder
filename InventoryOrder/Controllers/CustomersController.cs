...
namespace InventoryOrder.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            ...
            customer.Orders = _orderRepository.GetAll().Where(x => x.CustomerID == id).ToList(); // قم بإنشاء هذه الدالة في `OrderRepository`


            customer.PaymentCustomers = _paymentRepository.GetAll().Where(x => x.CustomerID == id).ToList(); // قم بإنشاء هذه الدالة في `PaymentRepository`
